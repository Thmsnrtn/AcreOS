 ...
 *
 * The NINTH time in this program that prose has tripped a check meant for code:
 * `getRiskColor`'s new doc comment quotes the defective call it replaced, and
 * the caller sweep matched the quotation. It is a habit now, not a surprise.
 */
