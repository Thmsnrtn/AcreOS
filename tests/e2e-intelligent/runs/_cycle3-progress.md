...
- [x] Phase 4 — Deploy + client-auth smoke test — **PASS** (Option B fix). STR-026 301 works, sign-in → /today renders dashboard, cross-route session persists. See `_cycle3-smoke-status.md`.
