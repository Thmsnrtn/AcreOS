...
const disclaimerMessages: Record<DisclaimerType, string> = {
  ...
  avm: "AcreOS AVM estimates are generated by a statistical model and are provided for informational purposes only. They are not appraisals and should not be used as the sole basis for purchase, sale, or financing decisions. Actual market values may differ. Consult a licensed appraiser or real estate professional.",
};
