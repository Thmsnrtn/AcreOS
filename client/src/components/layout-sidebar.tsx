...
const NAV_MODULES: NavModule[] = [
  ...
  // attention.
  {
    ...
    overflow: [
      ...
      // ── Ops / admin ────────────────────────────────────────────────
      { label: "System keys", icon: Key, href: "/founder/autopilot/control?tab=keys", description: "Platform-wide API keys (BYOK overrides) — a Controls tab" },
      { label: "Launch readiness", icon: ListChecks, href: "/founder/autopilot/control?tab=readiness", description: "Daily-during-launch progress checklist — a Controls tab" },
      ...
      { label: "Recovery console", icon: LifeBuoy, href: "/founder/autopilot/control?tab=recovery", description: "Last-resort account recovery (a Controls tab) — 2FA, sessions, autopay, ownership" },
