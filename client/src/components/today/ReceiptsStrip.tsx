        ...
        {receipts.map((r) => (
          <motion.li key={r.id} role="listitem" variants={staggerItem}>
            <Link
              ...
              className="inline-flex items-center gap-1.5 min-h-11 sm:min-h-9 px-3 py-1.5 rounded-full border border-[color:var(--acr-line-soft)] bg-acr-surface text-sm md:text-xs text-acr-ink-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring active:opacity-70 [@media(hover:hover)]:hover:border-[color:var(--acr-brand)]/40"
            >
