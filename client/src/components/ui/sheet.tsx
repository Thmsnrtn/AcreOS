...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      // z-modal (60) sits above MobileBottomNav (z-floating/50) so the bottom
      // nav doesn't paint over sheet scrims on mobile.
      "fixed inset-0 z-modal command-backdrop data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
