...
export function AnalyticsContent() {
  ...
  return (
    <div className="space-y-6 md:space-y-8" data-testid="analytics-content">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl md:text-2xl font-bold" data-testid="text-analytics-subtitle">Reports & Analytics</h2>
