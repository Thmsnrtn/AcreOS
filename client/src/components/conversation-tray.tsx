...
export function ConversationTray() {
    ...
    return (
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <Button
            size="icon"
            className="fixed bottom-[160px] md:bottom-24 right-4 z-[49] rounded-full shadow-lg safe-area-bottom"
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-[160px] md:bottom-24 right-4 z-[49] w-[360px] h-[500px] bg-background border rounded-lg shadow-xl flex flex-col overflow-hidden safe-area-bottom">
