  ...
  if (error) {
    return (
      <div className="flex min-h-screen bg-background">
        <Sidebar />
        <main className="flex-1 md:ml-[calc(16rem+16px)] p-6">
      ...
      <main className="flex-1 md:ml-[calc(16rem+16px)] p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center">
            <div>
              <h1 className="text-3xl font-bold" data-testid="text-page-title">Team Dashboard</h1>
            ...
            <Select value={period} onValueChange={setPeriod} data-testid="select-period">
              <SelectTrigger className="w-40" data-testid="select-trigger-period">
          ...
          {isLoading ? (
            ...
            <>
              ...
              <Tabs defaultValue="leaderboard" className="space-y-4">
                <TabsList data-testid="tabs-team-dashboard">
                ...
                <TabsContent value="charts" className="space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="h-[300px]" data-testid="chart-conversion">
                          <ResponsiveContainer width="100%" height="100%">
