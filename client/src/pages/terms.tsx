        ...
        <Card className="border-border/50" data-testid="card-terms">
          <CardContent ref={docRef} className="p-6 md:p-8 space-y-8">
            ...
            <section className="space-y-4" data-testid="section-description">
              ...
              <p className="text-muted-foreground leading-relaxed">
                The Service is designed for land investors.
            ...
            <section className="space-y-4" data-testid="section-payment">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                with our refund policy. We reserve the right to change pricing with <span className="tabular-nums">30</span> days' notice. Credit-based services
            ...
            <section className="space-y-4" data-testid="section-liability">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                you paid us in the twelve (<span className="tabular-nums">12</span>) months preceding the claim.
              </p>
            </section>
            ...
            <section className="space-y-4" data-testid="section-termination">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>You may request export of your data within <span className="tabular-nums">30</span> days</li>
