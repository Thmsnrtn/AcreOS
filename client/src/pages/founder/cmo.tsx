        ...
        <section aria-labelledby="cmo-pending-h">
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              subtitle="No ad bundles waiting for approval. New variants surface here as the CMO agent generates them."
              // TODO(cta): CMO review queue is system-generated by the CMO agent
