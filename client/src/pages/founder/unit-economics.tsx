      ...
      {!isLoading && (data?.rows.length ?? 0) === 0 ? (
        <Card>
          <CardContent className="p-0">
            <EmptyState
              icon={Users}
              headline="No customer snapshots yet"
              subtitle="The unit-economics rollup runs nightly. Once you have paying customers and the job has executed, this page will show their per-customer profitability."
              // TODO(cta): unit-economics snapshots are system-generated by the nightly job; no direct founder action
