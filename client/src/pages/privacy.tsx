          ...
          <CardContent className="p-6 md:p-8 space-y-8">
            ...
            <section className="space-y-4" data-testid="section-data-retention">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li><strong>After cancellation:</strong> We retain data for <span className="tabular-nums">90</span> days to allow for account reactivation
                    and data export.</li>
                <li><strong>Permanent deletion:</strong> Upon request, we will permanently delete your data within <span className="tabular-nums">30</span> days,
                    except where retention is required by law.</li>
                <li><strong>Backup systems:</strong> Backups are purged within <span className="tabular-nums">30</span> days of deletion from primary systems.</li>
            ...
            <section className="space-y-4" data-testid="section-security">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                is <span className="tabular-nums">100</span>% secure. We cannot guarantee absolute security.
              </p>
            </section>
            ...
            <section className="space-y-4" data-testid="section-children">
              ...
              <p className="text-muted-foreground leading-relaxed">
                The Service is not intended for individuals under the age of <span className="tabular-nums">18</span>. We do not knowingly collect
                personal information from children. If we learn that we have collected personal information
                from a child under <span className="tabular-nums">18</span>, we will take steps to delete such information promptly.
              </p>
            </section>
