        ...
        <Card>
          ...
          <CardContent>
            {weekly.length === 0 ? (
              <EmptyState
                icon={Lightbulb}
                headline="No weekly proposals"
                subtitle="Weekly proposals fire Sundays at 00:00 UTC. Run one now from the button above to seed the queue."
                // TODO(cta): weekly proposals are system-generated by cron; the manual run button is the CTA (above, outside this component)
