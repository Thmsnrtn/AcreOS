            ...
            <Card>
              ...
              <CardContent>
                {data.agentTrustTrajectories.length === 0 ? (
                  <EmptyState
                    icon={Activity}
                    headline="No trust-evolution data yet"
                    subtitle="Per-agent trust scores evolve on the monthly cadence. Come back after the first trust-evolution cron run."
                    // TODO(cta): trust data is system-generated by the cron; no direct user action produces it
