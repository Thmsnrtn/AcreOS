      ...
      <div className="space-y-6 max-w-5xl mx-auto">
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            subtitle="The meta-agent runs on the 1st of each month. You can also run it on demand from the button above."
            // TODO(cta): proposals are system-generated by the meta-agent; no direct user action creates them
