    ...
    <div className="flex min-h-screen bg-background desert-gradient">
      ...
      <main className="flex-1 md:ml-[17rem] p-4 pt-16 md:pt-8 md:p-8 pb-24 md:pb-8 overflow-x-hidden">
        <div className="max-w-4xl mx-auto space-y-8">
          {/* Header */}
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white flex items-center gap-2" data-testid="text-help-title">
              <HelpCircle className="w-8 h-8" />
              Help Center
            </h1>
            <p className="text-slate-500 mt-2">
              Learn how to use AcreOS to manage your land investing business.
            </p>
          </div>
            ...
            <CardContent className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Visit the Support page to chat with our team or submit a ticket.
                </p>
              </div>
              <a 
                href="/support" 
