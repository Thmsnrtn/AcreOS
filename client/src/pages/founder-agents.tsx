...
const AGENT_LABELS: Record<string, { label: string; description: string }> = {
  customer_success: { label: "Customer Success", description: "Check-in emails, re-engagement, milestones" },
  growth: { label: "Growth Intelligence", description: "Daily signups, activation tracking, weekly briefs" },
  revenue: { label: "Revenue Operations", description: "MRR monitoring, upgrade nudges, payment alerts" },
  operations: { label: "Operations", description: "Data source health, API monitoring, ops briefs" },
  digest: { label: "Founder Digest", description: "Daily briefing aggregating all agent activity" },
};
