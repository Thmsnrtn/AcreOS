...
export const ALL_NAV_ITEMS: MasterNavItem[] = [
  ...
  { id: "ai-hub-chat",  label: "Pax",             icon: Bot,         href: "/ai",            description: "Pax — chat, drafts, and what is waiting for your tap" },
  { id: "activity",      label: "Activity",        icon: Activity,    href: "/activity",       description: "Activity log — what Pax and your team did" },
