...
const VOCABULARY = {
  ...
  // The priced artefact a user puts in front of a counterparty.
  "entity.offer": {
    land_investor: "Offer",
    note_investor: "Offer",
    note_originator: "Note terms",
    note_servicer: "Offer",
    tax_delinquent: "Bid",
    wholesaler: "Offer",
    subdivider: "Offer",
  ...
  "entity.offer.plural": {
    land_investor: "Offers",
    note_investor: "Offers",
    note_originator: "Note terms",
    note_servicer: "Offers",
    tax_delinquent: "Bids",
    wholesaler: "Offers",
    subdivider: "Offers",
    fix_flipper: "Offers",
  ...
  // The counterparty on the disposition side.
  "entity.buyer": {
    land_investor: "Buyer",
    note_investor: "Note buyer",
    note_originator: "Note buyer",
    note_servicer: "Buyer",
    tax_delinquent: "Buyer",
    wholesaler: "Cash buyer",
    subdivider: "Lot buyer",
    fix_flipper: "Buyer",
    landlord: "Buyer",
  },
  "entity.buyer.plural": {
    land_investor: "Buyers",
    note_investor: "Note buyers",
    note_originator: "Note buyers",
    note_servicer: "Buyers",
    tax_delinquent: "Buyers",
    wholesaler: "Cash buyers",
    subdivider: "Lot buyers",
    fix_flipper: "Buyers",
    landlord: "Buyers",
  },
