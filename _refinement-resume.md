...
**asChild link sweep #7 — 7 pages, 10 violations (331):** ✅ complete — deals.tsx (3: Create package + empty-state + per-package View), ops-dashboard.tsx (1: View all + variable aria-label moves onto <Link>), finance.tsx (1: Stripe empty state), market-data.tsx (1: Start free auth CTA), terms.tsx (1: Back to AcreOS), privacy.tsx (1: Back to AcreOS), certification-requirements.tsx (2: View leaderboard + per-tier Start working toward). (commit `c554bc9`)
