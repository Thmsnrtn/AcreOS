...
// Free tier (5-min interval default). Minimum required fields only —
// any optional setting (interval other than the default, timeout, http_method,
// custom_http_statuses) triggers access_denied on the free plan.
const MONITORS = [
  {
