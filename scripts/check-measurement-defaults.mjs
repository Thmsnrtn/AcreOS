...
const BASELINE = new Set([
  ...
  "server/services/agentInitiativeEngine.ts::agent?.trustScore ?? 50",
  ...
  "server/services/dataIntelligenceEngine.ts::intel.dataQualityScore ?? 0.5",
  "server/services/dataIntelligenceEngine.ts::intel.medianDomDays ?? 180",
  "server/services/dataIntelligenceEngine.ts::intel.medianHouseholdIncome ?? 50000",
  "server/services/executionEngine.ts::agent?.trustScore ?? 50",
  ...
  "server/services/leadIntelligenceEngine.ts::nassData?.pasturePerAcre || 1000",
  ...
  "server/services/marketIntelligence.ts::latestMetric.marketHealthScore || 50",
  ...
  "server/services/parcelIntelligenceFusion.ts::profileData?.opportunityScore || 50",
