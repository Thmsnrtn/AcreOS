...
<!-- AUTO -->
<!-- generated by scripts/regenerate-team-state.mjs at 2026-07-07T23:14:14Z -->

## Auto-generated team state

_Last regenerated: 2026-07-07T23:14:14Z (UTC). Cron: every 15 minutes._
...
- **unattributed** has working-tree modifications:
  ...
  - `client/src/components/offer-wizard.tsx`
  - `lient/src/hooks/use-feature-flags.ts`
  - `lient/src/lib/nav-items.ts`
  - `lient/src/pages/finance.tsx`
  - `lient/src/pages/settings/pax-controls.tsx`
  - `ocs/internal/solene-team-state.md`
  - `cripts/migrate.mjs`
  - `erver/routes-seo-head.ts`
  - `erver/routes-subscription.ts`
  - `erver/routes.ts`
  - `hared/schema.ts`
  - `ests/unit/featureFlagFreeze.test.ts`
  - `migrations/0198_reactivation_surveys.sql`
