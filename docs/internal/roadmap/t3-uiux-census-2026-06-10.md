...
| W3-2 | founder/growth/campaigns.tsx (782 ln, sp5/sk0) → skeletons + error states | 1 file | M |
| W3-3 | founder/solene-chat.tsx + founder/chat.tsx — loading/error treatment on the surface Tom uses daily | 2 files | S |
| W3-4 | founder/keys, founder/readiness, founder/legal-readiness, founder/telemetry, founder/feed — skeleton+empty sweep (all small) | 5 files | M |
| W3-5 | recovery-console.tsx (1,341 ln) + asks.tsx (1,187 ln) decomposition + state consistency | 2 files | L |
