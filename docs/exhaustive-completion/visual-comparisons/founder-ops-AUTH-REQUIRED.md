# /founder/ops — Auth-gated visual comparison (1.1.B)

**Production URL:** https://acreos.io/founder/ops
**Captured:** 2026-04-28T01:42:17.952Z via Playwright + dev-bypass Clerk sign-in token

## Prototype reference

- Desktop (1440): `prototype-screenshots/founder-ops-1440.png` 
- Mobile (375):  `prototype-screenshots/founder-ops-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/founder-ops-1440.png`
- Mobile (375):  `auth-screenshots/founder-ops-375.png`
