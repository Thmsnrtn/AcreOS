# /contacts — Auth-gated visual comparison (1.1.B)

**Production URL:** https://acreos.io/contacts
**Captured:** 2026-04-28T01:42:17.939Z via Playwright + dev-bypass Clerk sign-in token

## Prototype reference

- Desktop (1440): `prototype-screenshots/contacts-1440.png` 
- Mobile (375):  `prototype-screenshots/contacts-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/contacts-1440.png`
- Mobile (375):  `auth-screenshots/contacts-375.png`
