# /audit — Auth-gated visual comparison (1.1.B)
...
- Desktop (1440): `prototype-screenshots/audit-1440.png` 
- Mobile (375):  `prototype-screenshots/audit-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/audit-1440.png`
- Mobile (375):  `auth-screenshots/audit-375.png`
