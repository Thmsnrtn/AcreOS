# /integrations — Auth-gated visual comparison (1.1.B)

**Production URL:** https://acreos.io/integrations
**Captured:** 2026-04-28T01:42:17.948Z via Playwright + dev-bypass Clerk sign-in token

## Prototype reference

- Desktop (1440): `prototype-screenshots/integrations-1440.png` 
- Mobile (375):  `prototype-screenshots/integrations-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/integrations-1440.png`
- Mobile (375):  `auth-screenshots/integrations-375.png`
