...
- Desktop (1440): `prototype-screenshots/agents-1440.png` 
- Mobile (375):  `prototype-screenshots/agents-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/agents-1440.png`
- Mobile (375):  `auth-screenshots/agents-375.png`
