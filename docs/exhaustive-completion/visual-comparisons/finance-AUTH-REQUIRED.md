# /finance — Auth-gated visual comparison (1.1.B)

**Production URL:** https://acreos.io/finance
**Captured:** 2026-04-28T01:42:17.944Z via Playwright + dev-bypass Clerk sign-in token

## Prototype reference

- Desktop (1440): `prototype-screenshots/finance-1440.png` 
- Mobile (375):  `prototype-screenshots/finance-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/finance-1440.png`
- Mobile (375):  `auth-screenshots/finance-375.png`

## Capture metadata

| Breakpoint | File size | Final URL | Issues |
|---|---|---|---|
| 1440 | 377KB | (no redirect) | 5 |
| 375 | 269KB | (no redirect) | 5 |
