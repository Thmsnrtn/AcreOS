# /ai — Auth-gated visual comparison (1.1.B)

**Production URL:** https://acreos.io/ai
**Captured:** 2026-04-28T11:27:57.649Z via Playwright + dev-bypass Clerk sign-in token

## Prototype reference

- Desktop (1440): `prototype-screenshots/pax-1440.png` 
- Mobile (375):  `prototype-screenshots/pax-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/pax-1440.png`
- Mobile (375):  `auth-screenshots/pax-375.png`

## Capture metadata

| Breakpoint | File size | Final URL | Issues |
|---|---|---|---|
| 1440 | 648KB | (no redirect) | 5 |
