# /campaigns — Auth-gated visual comparison (1.1.B)

**Production URL:** https://acreos.io/campaigns
**Captured:** 2026-04-28T11:27:57.639Z via Playwright + dev-bypass Clerk sign-in token

## Prototype reference

- Desktop (1440): `prototype-screenshots/campaigns-1440.png` 
- Mobile (375):  `prototype-screenshots/campaigns-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/campaigns-1440.png`
- Mobile (375):  `auth-screenshots/campaigns-375.png`

## Capture metadata

| Breakpoint | File size | Final URL | Issues |
|---|---|---|---|
| 1440 | 193KB | (no redirect) | 5 |
| 375 | 159KB | (no redirect) | 5 |
