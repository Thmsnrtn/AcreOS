# /dispositions — Auth-gated visual comparison (1.1.B)

**Production URL:** https://acreos.io/dispositions
**Captured:** 2026-04-28T11:27:57.645Z via Playwright + dev-bypass Clerk sign-in token

## Prototype reference

- Desktop (1440): `prototype-screenshots/dispos-1440.png` 
- Mobile (375):  `prototype-screenshots/dispos-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/dispos-1440.png`
- Mobile (375):  `auth-screenshots/dispos-375.png`
