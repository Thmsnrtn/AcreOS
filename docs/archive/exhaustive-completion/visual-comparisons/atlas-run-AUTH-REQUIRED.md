...
- Desktop (1440): `prototype-screenshots/atlas-run-1440.png` 
- Mobile (375):  `prototype-screenshots/atlas-run-375.png` 

## Production capture (this run)

- Desktop (1440): `auth-screenshots/atlas-run-1440.png`
- Mobile (375):  `auth-screenshots/atlas-run-375.png`
