...
export const DECISIONS: Decision[] = [
  ...
  // Category 2 — Global platform tweaks
  {
    ...
    surface: '/today',
    description:
      'Compact / comfortable / spacious / custom — applied as CSS variable overrides at 1.1.F',
    options: [
      { id: 'compact', label: 'Compact', description: 'Tighter spacing, more content per viewport' },
      { id: 'comfortable', label: 'Comfortable', description: 'Default — balanced' },
      { id: 'spacious', label: 'Spacious', description: 'More breathing room' },
      { id: 'custom', label: 'Custom', description: 'Fine-tune individual scales' },
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'brand-default', label: 'Default — terracotta', description: 'Current production value' },
